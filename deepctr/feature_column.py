...
def get_linear_logit(features, feature_columns, units=1, use_bias=False, seed=1024, prefix='linear', suffix='', l2_reg=0):
    ...
    linear_emb_list = [input_from_feature_columns(features, linear_feature_columns, l2_reg, seed,
                                                  prefix=prefix + str(i), suffix=suffix)[0] for i in range(units)]
    _, dense_input_list = input_from_feature_columns(features, linear_feature_columns, l2_reg, seed, prefix=prefix, suffix=suffix)
...
def input_from_feature_columns(features, feature_columns, l2_reg, seed, prefix='', suffix='', seq_mask_zero=True,
    ...
    embedding_matrix_dict = create_embedding_matrix(feature_columns, l2_reg, seed, prefix=prefix, suffix=suffix,
