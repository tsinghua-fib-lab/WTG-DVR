...
def create_embedding_dict(sparse_feature_columns, varlen_sparse_feature_columns, seed, l2_reg,
                          prefix='sparse_', suffix='prediction', seq_mask_zero=True):
    sparse_embedding = {}
    for feat in sparse_feature_columns:
        emb = Embedding(feat.vocabulary_size, feat.embedding_dim,
                        embeddings_initializer=feat.embeddings_initializer,
                        embeddings_regularizer=l2(l2_reg),
                        name=prefix + '_emb_' + feat.embedding_name + suffix)
        ...
        for feat in varlen_sparse_feature_columns:
            ...
            emb = Embedding(feat.vocabulary_size, feat.embedding_dim,
                            ...
                            embeddings_regularizer=l2(
                                l2_reg),
                            name=prefix + '_seq_emb_' + feat.name + suffix,
...
def create_embedding_matrix(feature_columns, l2_reg, seed, prefix="", suffix="", seq_mask_zero=True):
    ...
    sparse_emb_dict = create_embedding_dict(sparse_feature_columns, varlen_sparse_feature_columns, seed,
                                            l2_reg, prefix=prefix + 'sparse', suffix=suffix, seq_mask_zero=seq_mask_zero)
